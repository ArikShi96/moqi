...
$(document).ready(() => {
  ...
  const textMaps = {
    ...
    2019: {
      ...
      desc:
        "<li>正或发布新一代“指纹 - 身份识别” AI 系统，在业内引起巨大反响</li><li>入选部委“双十计划”重点推广项目</li><li>研发全球颠覆性的非接触指纹采集仪</li>",
      translateX: -12,
    },
    2020: {
      text: ["2019", "2020", "至今", "..."],
      desc:
        "<li>推出掌纹、足迹智能比对系统</li><li>入选黑马中国“新基建产业独角兽 100 强”</li><li>入选“2020 中国潜在独角兽企业榜单”</li><li>推出统一身份认证平台 Moqi ID</li>",
      translateX: -16,
    },
    至今: {
      text: ["2020", "至今", "...", ""],
