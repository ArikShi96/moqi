  ...
  const descriptionMap = [
    {
      ...
      desc:
        "利用多尺度的图像表示、高速异构的比对框架和分布式的并行处理，实现了 20 亿指纹秒级精准搜索的现实需求",
    },
    {
    ...
    },
    {
      ...
      desc:
        " 通过最新的非易失性内存（NVDIMM）技术和 Linux 系统中的内存映射技（mmap）将异构并行计算算法需要的所有图片特征存储在一个分布式的内存数据库内，完成大大降低了海量图像搜索成本，并增强了分布式图像搜索系统的稳定",
    },
    {
